...
public abstract class BaseSourceTask<P extends Partition, O extends OffsetContext> extends SourceTask {
    ...
    public List<SignalChannelReader> getAvailableSignalChannels() {
        List<SignalChannelReader> list = new ArrayList<>();
        list.add(new FileSignalChannel());
        list.add(new JmxSignalChannel());
        list.add(new KafkaSignalChannel());
        list.add(new SourceSignalChannel());
        return list;
    }
