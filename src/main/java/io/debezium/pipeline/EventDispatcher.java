...
import io.debezium.pipeline.signal.actions.snapshotting.*;
import io.debezium.pipeline.signal.channels.SourceSignalChannel;
import io.debezium.pipeline.source.snapshot.incremental.IncrementalSnapshotChangeEventSource;
import io.debezium.pipeline.source.spi.DataChangeEventListener;
import io.debezium.pipeline.source.spi.EventMetadataProvider;
import io.debezium.pipeline.spi.*;
...
public class EventDispatcher<P extends Partition, T extends DataCollectionId> implements AutoCloseable {
    ...
    public Map<String, SignalAction<P>> getSignalingActions() {
        ...
        Map<String, SignalAction<P>> map = new HashMap<>();
        map.put(Log.NAME, new Log<>());
        map.put(SchemaChanges.NAME, getSchemaChangeAction(this.connectorConfig));
        map.put(ExecuteSnapshot.NAME, new ExecuteSnapshot<>(this));
        map.put(StopSnapshot.NAME, new StopSnapshot<>(this));
        map.put(OpenIncrementalSnapshotWindow.NAME, new OpenIncrementalSnapshotWindow<>());
        map.put(CloseIncrementalSnapshotWindow.NAME, new CloseIncrementalSnapshotWindow<>(this));
        map.put(PauseIncrementalSnapshot.NAME, new PauseIncrementalSnapshot<>(this));
        map.put(ResumeIncrementalSnapshot.NAME, new ResumeIncrementalSnapshot<>(this));
    ...
    private final class BufferingSnapshotChangeRecordReceiver implements SnapshotReceiver<P> {
        ...
        public void completeSnapshot() throws InterruptedException {
            ...
            if (event != null) {
                ...
                @SuppressWarnings("unchecked") final Map<String, Object> offset = (Map<String, Object>) record.sourceOffset();
                offset.clear();
