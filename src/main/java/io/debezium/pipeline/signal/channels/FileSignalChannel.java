...
public class FileSignalChannel implements SignalChannelReader {
    ...
    public List<SignalRecord> read() {
        ...
        try {
            ...
            while (lineIterator.hasNext()) {
                ...
                if (signalLine == null || StringUtils.isBlank(signalLine)) {
    ...
    private SignalRecord readSignalString(String signalLine) throws JsonProcessingException {
        ...
        Map<String, Object> additionalData = signalJson.has("additionalData") ? mapper.convertValue(signalJson.get("additionalData"), new TypeReference<Map<String, Object>>() {
        }) : map;
